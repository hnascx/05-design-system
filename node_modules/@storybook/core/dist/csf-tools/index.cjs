...
var p = (s, e) => F(s, "name", { value: e, configurable: !0 });
var We = (s, e) => () => (e || s((e = { exports: {} }).exports, e), e.exports), ze = (s, e) => {
  for (var i in e)
    F(s, i, { get: e[i], enumerable: !0 });
}, se = (s, e, i, t) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let r of Ue(e))
      !Be.call(s, r) && r !== i && F(s, r, { get: () => e[r], enumerable: !(t = $e(e, r)) || t.enumerable });
  return s;
};
var $ = (s, e, i) => (i = s != null ? Me(qe(s)) : {}, se(
  // If the importer is in node compatibility mode or this is not an ESM
  // file that has been converted to a CommonJS file using a Babel-
  // compatible transform (i.e. "__esModule" has not been set), then set
  // "default" to the CommonJS "module.exports" for node compatibility.
  e || !s || !s.__esModule ? F(i, "default", { value: s, enumerable: !0 }) : i,
  s
)), Ge = (s) => se(F({}, "__esModule", { value: !0 }), s);
...
ze(ot, {
  ...
  CsfFile: () => U,
  NoMetaError: () => V,
  babelParse: () => we.babelParse,
  babelParseFile: () => fe,
  enrichCsf: () => st,
  enrichCsfMeta: () => Oe,
  enrichCsfStory: () => Se,
  extractDescription: () => ee,
  extractSource: () => Pe,
  formatConfig: () => be,
  formatCsf: () => K,
...
var q = require("node:fs/promises"), c = require("@storybook/core/babel"), P = require("@storybook/csf"), k = $(T(), 1);
...
p(ae, "parseTags");
var J = /* @__PURE__ */ p((s, e) => {
  let { line: i, column: t } = s.loc?.start || {};
  return `${e || ""} (line ${i}, col ${t})`.trim();
}, "formatLocation"), pe = /* @__PURE__ */ p((s) => Qe.test(s), "isModuleMock"), le = /* @__PURE__ */ p((s, e, i) => {
  let t = s;
  ...
  return !1;
}, "hasMount"), Qe = /^[.\/#].*\.mock($|\.[^.]*$)/i, V = class extends Error {
  static {
    p(this, "NoMetaError");
  }
  constructor(e, i, t) {
  ...
  _parseTitle(e) {
    ...
    throw new Error(k.dedent`
      CSF: unexpected dynamic title ${J(i, this._options.fileName)}
    ...
    e.properties.forEach((r) => {
      if (c.types.isIdentifier(r.key)) {
        if (this._metaAnnotations[r.key.name] = r.value, r.key.name === "title")
          ...
          let a = r.value;
          c.types.isIdentifier(a) && (a = O(a.name, this._ast.program)), t.tags = ae(a);
  ...
  parse() {
    ...
    if ((0, c.traverse)(this._ast, {
        ...
        enter({ node: t, parent: r }) {
          ...
          isFunctionDeclaration(t.declaration) && (a = [t.declaration]), a ? a.forEach((n) => {
            if (c.types.isIdentifier(n.id)) {
              ...
              })) : x.__isArgsStory = le(d, r, e), e._stories[l] = {
                id: "FIXME",
                name: u,
                parameters: x,
                __stats: {}
      ...
      CallExpression: {
        enter({ node: t }) {
          ...
          if (c.types.isIdentifier(r) && r.name === "storiesOf")
            throw new Error(k.dedent`
              Unexpected \`storiesOf\` usage: ${J(t, e._options.fileName)}.
      ...
      throw new V("missing default export", e._ast, e._options.fileName);
    ...
    e._stories = i.reduce(
      (t, [r, a]) => {
        ...
        play), b.moduleMock = !!e.imports.find((S) => pe(S)), t;
      },
      {}
  ...
  get indexInputs() {
    ...
    if (!e)
      throw new Error(
        k.dedent`Cannot automatically create index inputs with CsfFile.indexInputs because the CsfFile instance was created without a the fileName option.
  ...
  filename: e = "",
  ast: i
}) => new c.BabelFileClass({ filename: e }, { code: s, ast: i ?? (0, c.babelParse)(s) }), "babelParseFile"), B = /* @__PURE__ */ p((s, e) => {
  let i = (0, c.babelParse)(s), t = fe({ code: s, filename: e.fileName, ast: i });
  return new U(i, e, t);
}, "loadCsf"), K = /* @__PURE__ */ p((s, e = { sourceMaps: !1 }, i) => {
  let t = (0, c.generate)(s._ast, e, i);
  return e.sourceMaps ? t : t.code;
}, "formatCsf"), de = /* @__PURE__ */ p((s, e = {}) => c.recast.print(s._ast, e), "printCsf"), He = /* @__PURE__ */ p(async (s, e) => {
  let i = (await (0, q.readFile)(s, "utf-8")).toString();
  ...
  await (0, q.writeFile)(e, de(s).code);
}, "writeCsf");

// src/csf-tools/ConfigFile.ts
var G = require("node:fs/promises"), o = require("@storybook/core/babel"), ue = $(T(), 1);
var X = console, Q = /* @__PURE__ */ p(({
  expectedType: s,
  foundType: e,
  node: i
}) => {
  ...
  return ue.dedent`
      ...
      ${t}
    `;
}, "getCsfParsingErrorMessage"), A = /* @__PURE__ */ p((s) => o.types.isIdentifier(s.key) ? s.key.name : o.types.isStringLiteral(s.key) ? s.
key.value : null, "propKey"), W = /* @__PURE__ */ p((s) => o.types.isTSAsExpression(s) || o.types.isTSSatisfiesExpression(s) ? W(s.expression) :
s, "unwrap"), me = /* @__PURE__ */ p((s, e) => {
  if (s.length === 0)
    return e;
  if (o.types.isObjectExpression(e)) {
    let [i, ...t] = s, r = e.properties.find((a) => A(a) === i);
    if (r)
      return me(t, r.value);
  }
  ...
  id.name === s ? (i = a, !0) : !1))), i;
}, "_findVarDeclarator"), I = /* @__PURE__ */ p((s, e) => xe(s, e)?.init, "_findVarInitialization"), R = /* @__PURE__ */ p((s, e) => {
  if (s.length === 0)
    return e;
  let [i, ...t] = s, r = R(t, e);
  ...
  a ? o.types.isObjectExpression(a.value) && r.length > 0 ? H(r, e, a.value) : a.value = R(r, e) : i.properties.push(
    o.types.objectProperty(o.types.identifier(t), R(r, e))
  );
    ...
    return (0, o.traverse)(this._ast, {
      ExportDefaultDeclaration: {
        enter({ node: i, parent: t }) {
          ...
          r = W(r), o.types.isObjectExpression(r) ? (e._exportsObject = r, r.properties.forEach((a) => {
            let n = A(a);
            if (n) {
              let l = a.value;
        ...
        enter({ node: i, parent: t }) {
          if (o.types.isAssignmentExpression(i.expression) && i.expression.operator === "=") {
            ...
            r.property.name === "exports") {
              let n = a;
              o.types.isIdentifier(a) && (n = I(a.name, t)), n = W(n), o.types.isObjectExpression(n) ? (e._exportsObject = n, n.properties.forEach(
              (l) => {
                let u = A(l);
                if (u) {
                  let d = l.value;
  ...
  setFieldNode(e, i) {
    ...
    if (this._exportsObject)
      ...
      {
        let n = R(r, i), l = o.types.exportNamedDeclaration(
    ...
    if (e.length === 1) {
      ...
      if (this._ast.program.body.forEach((a) => {
        ...
        if (o.types.isExportDefaultDeclaration(a)) {
          let n = a.declaration;
          if (o.types.isIdentifier(n) && (n = I(n.name, this._ast.program)), n = W(n), o.types.isObjectExpression(n)) {
            let l = n.properties;
            i(l, e[0]), r = !0;
          }
        }
...
rtSpecifier"), n = this._ast.program.body.find(
  ...
  return new z(i, s, e);
}, "loadConfig"), be = /* @__PURE__ */ p((s) => Ee(s).code, "formatConfig"), Ee = /* @__PURE__ */ p((s, e = {}) => o.recast.print(s._ast, e),
"printConfig"), Ze = /* @__PURE__ */ p(async (s) => {
  let e = (await (0, G.readFile)(s, "utf-8")).toString();
  return ye(e, s).parse();
}, "readConfig"), et = /* @__PURE__ */ p(async (s, e) => {
  let i = e || s.fileName;
  if (!i)
    throw new Error("Please specify a fileName for writeConfig");
  await (0, G.writeFile)(i, be(s));
}, "writeConfig");

// src/csf-tools/getStorySortParameter.ts
var y = require("@storybook/core/babel"), he = $(T(), 1);
var tt = console, Y = /* @__PURE__ */ p((s, e) => {
  let i;
  return s.properties.forEach((t) => {
    y.types.isIdentifier(t.key) && t.key.name === e && (i = t.value);
  }), i;
}, "getValue"), Z = /* @__PURE__ */ p((s) => {
  let e = L(s);
  if (y.types.isArrayExpression(e))
    return e.elements.map((i) => Z(i));
  if (y.types.isObjectExpression(e))
    return e.properties.reduce((i, t) => (y.types.isIdentifier(t.key) && (i[t.key.name] = Z(t.value)), i), {});
  ...
  if (e)
    throw new Error(i);
  tt.info(i);
}, "unsupported"), L = /* @__PURE__ */ p((s) => y.types.isTSAsExpression(s) || y.types.isTSSatisfiesExpression(s) ? s.expression : s, "strip\
TSModifiers"), _e = /* @__PURE__ */ p((s) => {
  let e = L(s);
  if (y.types.isObjectExpression(e)) {
    let i = Y(e, "options");
    if (i) {
      if (y.types.isObjectExpression(i))
        return Y(i, "storySort");
      N("options", !0);
    }
  }
  ...
  if ((0, y.traverse)(i, {
    ...
    ExportDefaultDeclaration: {
      enter({ node: t }) {
        let r = t.declaration;
        y.types.isIdentifier(r) && (r = O(r.name, i.program)), r = L(r), y.types.isObjectExpression(r) ? e = rt(r, i.program) : N("default",
        !1);
      }
    }
  }), !!e) {
    ...
    return y.types.isLiteral(e) || y.types.isArrayExpression(e) || y.types.isObjectExpression(e) ? Z(e) : N("storySort", !0);
  }
}, "getStorySortParameter");

// src/csf-tools/enrichCsf.ts
var m = require("@storybook/core/babel");
var Se = /* @__PURE__ */ p((s, e, i, t) => {
  let r = e.getStoryExport(i), a = !t?.disableSource && Pe(r), n = !t?.disableDescription && ee(e._storyStatements[i]), l = [], u = m.types.
...
}, "enrichCsfStory"), je = /* @__PURE__ */ p((s, e, i) => {
  if (!e.length) {
    s.properties.find(
  ...
  a ? n = a.value : (n = m.types.objectExpression([]), s.properties.push(m.types.objectProperty(m.types.identifier(t), n))), je(n, r, i);
}, "addComponentDescription"), Oe = /* @__PURE__ */ p((s, e, i) => {
  let t = !i?.disableDescription && ee(e._metaStatement);
  if (t) {
    let r = s._metaNode;
    r && m.types.isObjectExpression(r) && je(
      r,
  ...
  Oe(s, e, i), Object.keys(s._storyExports).forEach((t) => {
    Se(s, e, t, i);
  });
}, "enrichCsf"), Pe = /* @__PURE__ */ p((s) => {
...
// src/csf-tools/index.ts
var we = require("@storybook/core/babel");

// src/csf-tools/vitest-plugin/transformer.ts
var f = require("@storybook/core/babel"), ve = require("@storybook/core/common"), Ie = require("@storybook/csf"), te = $(T(), 1);
var De = console, nt = /* @__PURE__ */ p((s, e) => {
...
async function Ne({
  ...
  let l = B(s, {
    ...
    makeTitle: /* @__PURE__ */ p((E) => {
      let j = (0, ve.getStoryTitle)({
        storyFilePath: e,
        configDir: i,
        stories: t,
        userTitle: E
      }) || "unknown";
      return j === "unknown" && De.warn(
        te.dedent`
...
le an issue with details about your use case.`
  ...
  let S = l._file.path.scope.generateUidIdentifier("test"), re = l._file.path.scope.generateUidIdentifier("describe");
  if (Object.keys(h).length === 0) {
    let E = f.types.expressionStatement(
      f.types.callExpression(f.types.memberExpression(re, f.types.identifier("skip")), [
    ...
    let j = [
      f.types.importDeclaration(
        [
          ...
          f.types.importSpecifier(re, f.types.identifier("describe"))
        ],
    ...
    let ie = function() {
      let _ = l._file.path.scope.generateUidIdentifier("isRunningFromThisFile"), D = f.types.memberExpression(
      ...
      return { isRunningFromThisFileDeclaration: f.types.variableDeclaration("const", [
        f.types.variableDeclarator(_, Le)
      ]), isRunningFromThisFileId: _ };
    };
    var at = ie;
    p(ie, "getTestGuardDeclaration");
    let E = l._file.path.scope.generateUidIdentifier("expect"), j = l._file.path.scope.generateUidIdentifier("testStory"), Fe = f.types.identifier(
    JSON.stringify(r.skip)), { isRunningFromThisFileDeclaration: Ce, isRunningFromThisFileId: Te } = ie();
    u.program.body.push(Ce);
    let ke = /* @__PURE__ */ p(({
      exportName: _,
      testTitle: D,
      node: w
    }) => {
      let M = f.types.expressionStatement(
        f.types.callExpression(S, [
          f.types.stringLiteral(D),
          f.types.callExpression(j, [
            f.types.stringLiteral(_),
            f.types.identifier(_),
            f.types.identifier(d),
            Fe
          ])
        ])
      );
      return M.loc = w.loc, M;
    }, "getTestStatementForStory"), Ve = Object.entries(h).map(([_, D]) => {
      if (D === null) {
        De.warn(
          te.dedent`
      ...
      let w = l._stories[_].name ?? _;
      return ke({ testTitle: w, exportName: _, node: D });
    }).filter((_) => !!_), Ae = f.types.ifStatement(Te, f.types.blockStatement(Ve));
    u.program.body.push(Ae);
    let Re = [
      f.types.importDeclaration(
        [
          f.types.importSpecifier(S, f.types.identifier("test")),
    ...
    u.program.body.unshift(...Re);
  }
  return K(l, { sourceMaps: !0, sourceFileName: e }, s);
}
p(Ne, "vitestTransform");
